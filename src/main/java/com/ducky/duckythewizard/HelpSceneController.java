...
public class HelpSceneController {
    ...
    public void switchToHelpScene1(ActionEvent event) throws IOException {
        Parent root = (Parent)FXMLLoader.load((URL)Objects.requireNonNull(this.getClass().getResource("scenes/helpScenes/helpScene1.fxml")));
        getWindowStage(event, root);
    }


    public void switchToHelpScene2(ActionEvent event) throws IOException {
        Parent root = (Parent)FXMLLoader.load((URL)Objects.requireNonNull(this.getClass().getResource("scenes/helpScenes/helpScene2.fxml")));
        getWindowStage(event, root);
    }

    public void switchToHelpScene3(ActionEvent event) throws IOException {
        Parent root = (Parent)FXMLLoader.load((URL)Objects.requireNonNull(this.getClass().getResource("scenes/helpScenes/helpScene3.fxml")));
        getWindowStage(event, root);
    }

    public void switchToControls(ActionEvent event) throws IOException {
        Parent root = (Parent)FXMLLoader.load((URL)Objects.requireNonNull(this.getClass().getResource("scenes/helpScenes/controls.fxml")));
        getWindowStage(event, root);
    }

    public void startGame(ActionEvent event) throws IOException {
        // Britta's Code zum Starten des Games
        AnchorPane newRoot = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("scenes/game-view.fxml")));
